...
// viewModel
@property (nonatomic, readwrite, strong) FSLViewModel *viewModel;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    FSLViewController *viewController = [super allocWithZone:zone];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    /// 隐藏导航栏细线
    self.viewModel.prefersNavigationBarBottomLineHidden?[(FSLNavigationController *)self.navigationController hideNavigationBottomLine]:[(FSLNavigationController *)self.navigationController showNavigationBottomLine];
    /// 配置键盘
...
- (void)viewDidLoad {
    ...
    /// backgroundColor
    self.view.backgroundColor = FSL_MAIN_BACKGROUNDCOLOR;
