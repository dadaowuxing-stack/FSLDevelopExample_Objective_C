...
#import "FSLNewFeatureViewController.h"
#import "AppDelegate.h"

@interface FSLNewFeatureViewController () <UIScrollViewDelegate>
/// 滚动视图
...
/// viewModel
@property (nonatomic, readwrite, strong) FSLNewFeatureViewModel *viewModel;
@end

@implementation FSLNewFeatureViewController
...
- (void)clickStartButton {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:FSLSwitchRootViewControllerNotification object:nil userInfo:@{FSLSwitchRootViewControllerUserInfoKey:@(FSLSwitchRootViewControllerFromTypeNewFeature)}];
}
...
- (void)_prepareScrollView {
    ...
    /// 适配 iOS11
    FSLAdjustsScrollViewInsets_Never(self.scrollView);
}
...
- (UIButton *)startButton {
    if (_startButton == nil) {
        ...
        [_startButton setBackgroundImage:FSLImageNamed(@"new_feature_finish_button") forState:UIControlStateNormal];
