...
@interface FSLProfileInfoViewModel ()
/// user
...
@implementation FSLProfileInfoViewModel
...
- (void)initialize{
    ...
    /// 随机生成图片
    NSInteger count = [NSObject fsl_randomNumberWithFrom:0 to:4];
