...
@interface FSLObject : NSObject <YYModel,NSCopying,NSCoding>
...
// properties without ivars, or properties on FSLObject itself.
...
// Implements validation logic for FSLObject.
@interface FSLObject (Validation)
