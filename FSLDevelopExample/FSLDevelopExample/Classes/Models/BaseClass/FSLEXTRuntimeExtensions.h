...
typedef enum {
     ...
     */
    fsl_propertyMemoryManagementPolicyAssign = 0,
    
    /**
     * The value is retained.
     */
    fsl_propertyMemoryManagementPolicyRetain,
    
    /**
     * The value is copied.
     */
    fsl_propertyMemoryManagementPolicyCopy
} fsl_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #fsl_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    fsl_propertyMemoryManagementPolicy memoryManagementPolicy;
