//
//  FSLMomentOperationMoreItemView.m
//  FSLDevelopExample
//
...
@interface FSLMomentOperationMoreItemView ()
/// 动画图片
@property (nonatomic, readwrite, weak) UIImageView *animView;

@end

@implementation FSLMomentOperationMoreItemView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        /// 设置文字大小
        self.titleLabel.font = FSLRegularFont_14;
        /// 设置title内边距
