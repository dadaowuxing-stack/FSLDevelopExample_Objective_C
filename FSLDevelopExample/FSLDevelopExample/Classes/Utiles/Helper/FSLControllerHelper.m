...
+ (UIViewController *)currentViewController {
    ...
    /// CoderMikeHe Fixed : 这里必须要判断一下，否则取出来永远都是 FSLHomePageViewController。这是架构上小缺(特)陷(性)。因为MHHomePageViewController的子控制器是UITabBarController，所以需要递归UITabBarController的所有的子控制器
